...
const responsibility = [
  ...
  },
  {
    ...
    linkimg:
      "https://mcdn.coolmate.me/uploads/April2022/Anh_chup_Man_hinh_2021-07-21_luc_16.png",
  ...
  },
  {
    ...
    linkimg:
      "https://mcdn.coolmate.me/uploads/April2022/93865627_10217886564377529_1941617773784334336_n_1.jpg",
  ...
  },
  {
    ...
    linkimg:
      "https://mcdn.coolmate.me/uploads/April2022/Thiet_ke_chua_co_ten_(2)_1.jpg",
  ...
  return (
    <section className="responsibility-child">
      <Col
        ...
        xl={6}
        xxl={6}
        className="responsibility-child-left"
      >
        ...
        {item.child.map((content, index) => {
          return (
            <div className="responsibility-child-content" key={index}>
              {content}
            </div>
          );
        })}
      ...
      <Col
        ...
        xl={6}
        xxl={6}
        className="responsibility-child-right"
      >
    ...
    <div className="about-coolmate">
      <div className="coolmate-banner">
        ...
        <div className="coolmate-banner-content">
          <div className="banner-conten-titlet">
            <h1 className="title">Câu Chuyện Về Coolmate</h1>
            <span>
      ...
      <section className="coolmate-born">
        <Row className="coolmate-born-gird">
          ...
          <Col
            ...
            xl={8}
            xxl={9}
            className="coolmate-born-right"
          >
            {coolmateBorn.map((content) => {
              return <div className="coolmate-born-content">{content}</div>;
            })}
          </Col>
      ...
      <section className="direction-coolmate">
        <Col className="direction-coolmate-content">
          ...
          thiết thực và lâu dài
          <br />
          cho khách hàng, cho nhân viên, cho đối tác, cho cộng đồng , cho môi
          trường và cho cổ đông “
        </Col>
        <div className="direction-coolmate-author">
          <i>Nhu Phạm, CEO & Founder Coolmate</i>
        </div>
      </section>
      <section className="customer-ervice-story">
        <Col
          ...
          xl={5}
          xxl={5}
          className="customer-ervice-story-left"
        >
          <img
            src="https://mcdn.coolmate.me/uploads/April2022/1-8_14.jpg"
            alt=""
          />
          <div className="customer-ervice-story-note">
            {" "}
            <u>Đội ngũ nhân viên CSKH tại Coolmate</u>
          </div>
        </Col>
        <Col
          xs={12}
          ...
          xl={7}
          xxl={7}
          className="customer-ervice-story-right"
        >
      ...
      <section className="responsibility-coolmate">
        <h2 className="responsibility-coolmate-title">
          Câu chuyện mô hình doanh nghiệp CÓ TRÁCH NHIỆM Coolmate đang hướng tới
        </h2>
