...
// import choncesize from "../Style/choncesize.css";
...
//       title: "Áo Polo",
//       linkImgProduct:
//         "https://mcdn.coolmate.me/uploads/December2021/POLO2x.png",
...
//       title: "Áo Tank Top",
//       linkImgProduct:
//         "https://mcdn.coolmate.me/uploads/December2021/TANK_TOP2x.png",
...
//       title: "Quần Jeans",
//       linkImgProduct:
//         "https://mcdn.coolmate.me/uploads/December2021/JEANS2x.png",
...
//       title: "Quần Short",
//       linkImgProduct:
//         "https://mcdn.coolmate.me/uploads/December2021/EZ_ACTIV2x.png",
...
//       linkImgProduct:
//         "https://mcdn.coolmate.me/image/September2022/mceclip0_25.jpg",
//       linkImgTableSize: "../src/img/img-select-size/quan-trunk-cotton-pima.jpg",
//     },
//   ];
//   const bodyList = ["Gầy", "Bình thường", " Đầy đặn"];

//   const listChooseBody = [
//     { id: 1, title: "Chiều cao của bạn", min: 155, max: 200, unit: "cm" },
//     { id: 2, title: "Cân nặng  của bạn", min: 48, max: 90, unit: "kg" },
//   ];
...
//           </div>
//           <div className="container-fiter-name">{item.title}</div>
//         </Dropdown.Item>
//         <Dropdown.Divider />
//       </>
//     );
...
//           xl={4}
//           xxl={4}
//           className="container-fiter-left"
//         >
...
//           xl={8}
//           xxl={8}
//           className="container-fiter-right"
//         >
...
//               xl={8}
//               xxl={8}
//               className="choose-body-parameters"
//             >
...
//               <div className="suggestions-content">XL</div>
//             </Col>
//           </Row>
//           <hr />
//           {selectItem && (
...
//                   * Thông số cơ bản của các sản phẩm coolmate: Lấy chiếc áo mà
//                   các bạn đang mặc và cảm thấy vừa nhất sau đó đo các kích thước
//                   của áo,và đối chiếu với bảng thông số của chúng tôi theo các
//                   kích thước sau:
//                 </div>
//               </div>
